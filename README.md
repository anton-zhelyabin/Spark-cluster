...
## О проекте
В этом репозитории рассматривается:
- Обработка тестового массива данных (2 гб.) с использованием движка Spark.
- Сравнение времени сохранения результатов при разном числе партиций.
- Сравнение времени join'a с включённым broadcast join и выключеным.
